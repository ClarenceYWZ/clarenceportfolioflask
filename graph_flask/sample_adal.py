...
def login():
    ...
    # For this sample, the users selects an account to authenticate. Change
    # this value to 'none' for "silent SSO" behavior, and if the users is
...
@APP.route('/graphcall')
def graphcall():
    """Confirm users authentication by calling Graph and displaying some data."""
